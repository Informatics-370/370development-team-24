...
{
    public partial class LavaniSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DifferenceDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Inventory_TypeId = table.Column<int>(type: "int", nullable: false),
                    AdministratorId = table.Column<int>(type: "int", nullable: true),
                    StockTake_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inventory_Items_StockTakes_StockTake_Id",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Inventory_ItemId", "AdministratorId", "Description", "Inventory_TypeId", "ItemName", "Quantity", "StockTake_Id" },
                values: new object[,]
                {
                    { 1, null, "Freshly produced", 1, "Lettuce", 2, null },
                    { 2, null, "Used for all chicken dishes", 1, "Chicken", 6, null },
                    { 3, null, "Needs to be cooked well", 1, "Mogodu", 5, null },
                    { 4, null, "Served in all drinks with the gin recipie", 3, "Gin", 15, null },
                    { 5, null, "To Quench your Thirst", 2, "Coke", 24, null },
                    { 6, null, "For those who like no taste", 2, "Sarkling Water", 30, null },
                    { 7, null, "Many different types served", 3, "Beer", 12, null },
                    { 8, null, "One of the starches served with each dish", 1, "Rice", 4, null },
                    { 9, null, "One of the starches served with each dish", 1, "Maize Meal", 3, null },
                    { 10, null, "For those who do not like fizz", 2, "Apple Juice", 24, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventory_Items_StockTake_Id",
                table: "Inventory_Items",
                column: "StockTake_Id");
