    ...
    public partial class Mmino : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, 0.05m, "10% Discount", new DateTime(2023, 10, 10, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6466), "Month end discount", new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6465) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "VanessaJames@gmail.com", 1, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3102), "Vanessa", 2, "0847541236", "404 Jacob Street", 10000000, "James" },
                    { 2, "SerenaWilliams@gmail.com", 2, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3171), "Serena", 2, "0842341236", "132 Harriet Street", 10000000, "Williams" },
                    { 3, "EdrisElba@gmail.com", 1, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3192), "Edris", 1, "0212378798", "245 homelyn Street", 10000000, "Elba" },
                    { 4, "NyongoLupita@gmail.com", 2, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3213), "Lupita", 2, "0455783475", "254 Summer Street", 10000000, "Nyongo" },
                    { 5, "MicheaJackson@gmail.com", 2, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3234), "Micheal", 3, "0874567836", "567 Winter Street", 10000000, "Jackson" },
                    { 6, "TaehyungKim@gmial.com", 1, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3261), "Taehyung", 1, "0874562134", "345 Shallow  Street", 10000000, "Kim" },
                    { 7, "ZendayaColeman@gmail.com", 1, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3282), "Zendaya", 2, "0212378798", "243 Super Street ", 10000000, "Coleman" },
                    { 8, "RogerFederal@gmail.com", 1, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3302), "Roger", 3, "0612346487", "987 Wall Street", 10000000, "Federal" },
                    { 9, "JenniferLOpez@gmail.com", 2, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3323), "Jennifer", 3, "0874834576", "967 Ballard Street", 10000000, "Lopez" },
                    { 10, "ChadwickBoseman@gmail.com", 2, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(3346), "Chadwick", 1, "0923456789", "483 Alien Street", 10000000, "Boseman" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Schedules",
                columns: new[] { "ScheduleId", "AdministratorId", "Date", "Description", "End_Time", "EventId", "Schedule_StatusId", "Schedule_StatusId1", "Start_Time", "Title" },
                values: new object[,]
                {
                    { 1, null, "2023/06/25", "Musician can book performance", "15:00", 1, 1, null, "14:30", "Music slot" },
                    { 2, null, "2023/08/02", "Contemporary Dance performance", "12:30", 2, 1, null, "12:00", "Dance slot " },
                    { 3, null, "2023/07/22", "Poet recital", "21:30", 3, 2, null, "21:00", "Poetry" },
                    { 4, null, "2023/07/22", "Contemporary dance slot", "17:45", 2, 1, null, "17:00", "Contemp Dance" },
                    { 5, null, "2023/09/12", "Poet recital", "13:20", 3, 1, null, "13:00", "Comedy" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "ContactNumber", "Email", "EntertainmentType", "Entertainment_TypeId", "FirstName", "LastName", "Password", "PhysicalAddress", "RefreshToken", "RefreshTokenExpiryTime", "ResetPasswordToken", "ResetPasswordTokenExpiry", "Role", "TitleId", "Token", "Username" },
                values: new object[,]
                {
                    { 1, "0848887563", "VanessaJames@gmail.com", null, 1, "Vanessa", "James", "Vanessa123", "404 Jacob Street", "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3749), "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3749), "User", null, null, "Vanessa" },
                    { 2, "0848887564", "SerenaWilliams@gmail.com", null, 2, "Serena", "Williams", "Serena.123", "404 Williams Street", "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3779), "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3780), "User", null, null, "Serena" },
                    { 3, "0848887565", "VenusWilliams@gmail.com", null, 3, "Williams", "Venus", "Venus.123", "100 Venus Street", "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3799), "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3799), "User", null, null, "Venus" },
                    { 4, "0848887566", "Beast@gmail.com", null, 4, "Beast", "Bestie", "Beast.123", "808 Beast Street", "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3817), "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3817), "User", null, null, "Bee" },
                    { 5, "0848887567", "KidDanger@gmail.com", null, 3, "Danger", "Kid", "Danger.123", "500 Danger Street", "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3835), "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3835), "User", null, null, "KidDanger" },
                    { 6, "0848887568", "AdultDanger@gmail.com", null, 4, "Danger", "Adult", "Adult.123", "404 Adult Street", "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3885), "", new DateTime(2023, 9, 30, 12, 29, 13, 862, DateTimeKind.Utc).AddTicks(3886), "User", null, null, "AdultDanger" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6556), 1, 25m },
                    { 2, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6579), 2, 250m },
                    { 3, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6610), 3, 200m },
                    { 4, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6632), 4, 38m },
                    { 5, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6652), 5, 45m },
                    { 6, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6678), 6, 75m },
                    { 7, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6764), 7, 100m },
                    { 8, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6784), 8, 40m },
                    { 9, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6802), 9, 28m },
                    { 10, new DateTime(2023, 9, 30, 14, 29, 13, 862, DateTimeKind.Local).AddTicks(6823), 10, 35m }
                });
