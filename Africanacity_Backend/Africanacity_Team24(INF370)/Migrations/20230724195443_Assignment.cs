    ...
    public partial class Assignment : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntertainmentTypes", x => x.Entertainment_TypeId);
                    table.ForeignKey(
                        name: "FK_EntertainmentTypes_Entertainers_EntertainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "AdministratorId");
                    table.ForeignKey(
                        name: "FK_Schedules_Entertainers_EntertainerId",
                        column: x => x.EntertainerId,
                        principalTable: "Entertainers",
                        principalColumn: "EntertainerId");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "VanessaJames@gmial.com", null, "Vanessa", "0847541236", null, "James" });

            migrationBuilder.InsertData(
                table: "EntertainmentTypes",
                columns: new[] { "Entertainment_TypeId", "Date", "DateCreated", "DateModified", "Description", "End_Time", "EntertainerId", "IsActive", "IsDeleted", "Name", "Start_Time" },
                values: new object[,]
                {
                    { 1, null, null, null, "Poetry recitations", null, null, null, null, "Poetry", null },
                    { 2, null, null, null, "One-liners for a comedic performance", null, null, null, null, "StandUp Comedy", null },
                    { 3, null, null, null, "Present dance as an art form, ballet, amapiano styles, hipHop dancers", null, null, null, null, "Dance", null },
                    { 4, null, null, null, "Artits who perform own music. All types of music", null, null, null, null, "Music", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntertainmentTypes_EntertainerId",
                table: "EntertainmentTypes",
                column: "EntertainerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_EntertainerId",
                table: "Schedules",
                column: "EntertainerId");
