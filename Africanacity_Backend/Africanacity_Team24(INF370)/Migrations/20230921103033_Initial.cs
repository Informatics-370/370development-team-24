        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuItemQuantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_KitchenOrders_KitchenOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItem_Prices_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "OrderItemId");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, 0.05m, "10% Discount", new DateTime(2023, 10, 1, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(9797), "Month end discount", new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(9790) });

            migrationBuilder.InsertData(
                table: "Drink_Prices",
                columns: new[] { "Drink_PriceId", "Amount", "DrinkId", "OrderItemId" },
                values: new object[,]
                {
                    { 1, 55m, 1, null },
                    { 2, 75m, 2, null },
            ...
            migrationBuilder.InsertData(
                table: "Drinks",
                columns: new[] { "DrinkId", "Drink_TypeId", "Drink_TypeId1", "Name", "OrderItemId" },
                values: new object[,]
                {
                    { 1, 1, null, "Margarita", null },
                    { 2, 1, null, "Strawberry Daiquri", null },
                    { 3, 1, null, "Blood Mary", null },
                    { 4, 2, null, "Virgin Mojito", null },
                    { 5, 2, null, "Cappuccino", null },
                    { 6, 2, null, "Frozen lemonade", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "VanessaJames@gmail.com", 1, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5310), "Vanessa", 2, "0847541236", "404 Jacob Street", "James" },
                    { 2, "SerenaWilliams@gmail.com", 2, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5368), "Serena", 2, "0842341236", "132 Harriet Street", "Williams" },
                    { 3, "EdrisElba@gmail.com", 1, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5398), "Edris", 1, "0212378798", "245 homelyn Street", "Elba" },
                    { 4, "NyongoLupita@gmail.com", 2, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5426), "Lupita", 2, "0455783475", "254 Summer Street", "Nyongo" },
                    { 5, "MicheaJackson@gmail.com", 2, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5456), "Micheal", 3, "0874567836", "567 Winter Street", "Jackson" },
                    { 6, "TaehyungKim@gmial.com", 1, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5490), "Taehyung", 1, "0874562134", "345 Shallow  Street", "Kim" },
                    { 7, "ZendayaColeman@gmail.com", 1, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5517), "Zendaya", 2, "0212378798", "243 Super Street ", "Coleman" },
                    { 8, "RogerFederal@gmail.com", 1, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5543), "Roger", 3, "0612346487", "987 Wall Street", "Federal" },
                    { 9, "JenniferLOpez@gmail.com", 2, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5569), "Jennifer", 3, "0874834576", "967 Ballard Street", "Lopez" },
                    { 10, "ChadwickBoseman@gmail.com", 2, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(5599), "Chadwick", 1, "0923456789", "483 Alien Street", "Boseman" }
                });
            ...
            migrationBuilder.InsertData(
                table: "MenuItems",
                columns: new[] { "MenuItemId", "Description", "FoodTypeId", "Food_TypeFoodTypeId1", "Menu_CategoryId", "Menu_TypeId", "Menu_TypeId1", "Name", "OrderItemId" },
                values: new object[,]
                {
                    { 1, "Two larger chicken burger, 6 pcs nuggets, two large fries", 1, null, 3, 2, null, "Chicken Feast", null },
                    { 2, "Pap, boerewors an Tbone steak", 2, null, 3, 2, null, "The Braai feast", null },
                    { 3, "Mozarella stuffe cheese balls", 3, null, 2, 2, null, "Chilli cheese poppers", null },
                    { 4, "A green salad with salsa mix", 4, null, 5, 2, null, "Mexican salad", null },
                    { 5, "Delicious cheesecake with blueberry sauce topping", 3, null, 4, 2, null, "Blueberry cheescake slice", null },
                    { 6, "Delicious everyday english breakfast with eggs and bacon", 1, null, 1, 1, null, "English Breakfast", null },
                    { 7, "Smoothy bowl with blueberries, almond milk and honey", 4, null, 1, 1, null, "Blueberry smoothy bowl", null },
                    { 8, "A toasted panini sandwich with beef sausages, tomatos and cheese", 2, null, 1, 1, null, "Toatsed beef panini sandwich", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "0848887563", "VanessaJames@gmail.com", null, 1, "Vanessa", "James", "Vanessa123", "404 Jacob Street", "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6119), "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6120), "User", null, null, null, "Vanessa" },
                    { 2, "0848887564", "SerenaWilliams@gmail.com", null, 2, "Serena", "Williams", "Serena.123", "404 Williams Street", "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6162), "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6162), "User", null, null, null, "Serena" },
                    { 3, "0848887565", "VenusWilliams@gmail.com", null, 3, "Williams", "Venus", "Venus.123", "100 Venus Street", "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6190), "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6191), "User", null, null, null, "Venus" },
                    { 4, "0848887566", "Beast@gmail.com", null, 4, "Beast", "Bestie", "Beast.123", "808 Beast Street", "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6219), "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6220), "User", null, null, null, "Bee" },
                    { 5, "0848887567", "KidDanger@gmail.com", null, 3, "Danger", "Kid", "Danger.123", "500 Danger Street", "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6249), "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6249), "User", null, null, null, "KidDanger" },
                    { 6, "0848887568", "AdultDanger@gmail.com", null, 4, "Danger", "Adult", "Adult.123", "404 Adult Street", "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6279), "", new DateTime(2023, 9, 21, 10, 30, 30, 221, DateTimeKind.Utc).AddTicks(6280), "User", null, null, null, "AdultDanger" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(9907), 1, 25m },
                    { 2, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(9940), 2, 250m },
                    { 3, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(9965), 3, 200m },
                    { 4, new DateTime(2023, 9, 21, 12, 30, 30, 221, DateTimeKind.Local).AddTicks(9991), 4, 38m },
                    { 5, new DateTime(2023, 9, 21, 12, 30, 30, 222, DateTimeKind.Local).AddTicks(18), 5, 45m },
                    { 6, new DateTime(2023, 9, 21, 12, 30, 30, 222, DateTimeKind.Local).AddTicks(48), 6, 75m },
                    { 7, new DateTime(2023, 9, 21, 12, 30, 30, 222, DateTimeKind.Local).AddTicks(75), 7, 100m },
                    { 8, new DateTime(2023, 9, 21, 12, 30, 30, 222, DateTimeKind.Local).AddTicks(101), 8, 40m },
                    { 9, new DateTime(2023, 9, 21, 12, 30, 30, 222, DateTimeKind.Local).AddTicks(127), 9, 28m },
                    { 10, new DateTime(2023, 9, 21, 12, 30, 30, 222, DateTimeKind.Local).AddTicks(156), 10, 35m }
                });

            migrationBuilder.InsertData(
                table: "MenuItem_Prices",
                columns: new[] { "MenuItem_PriceId", "Amount", "MenuItemId", "OrderItemId" },
                values: new object[,]
                {
                    { 1, 50.50m, 5, null },
                    { 2, 105.35m, 1, null },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drink_Prices_OrderItemId",
                table: "Drink_Prices",
                column: "OrderItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItem_Prices_OrderItemId",
                table: "MenuItem_Prices",
                column: "OrderItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_KitchenOrderId",
                table: "OrderItems",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Drink_Prices_OrderItems_OrderItemId",
                table: "Drink_Prices",
                column: "OrderItemId",
                principalTable: "OrderItems",
                principalColumn: "OrderItemId");
